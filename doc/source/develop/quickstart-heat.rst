...
**OpenStack single full example env**

``/_static/scripts/envs/openstack_single.env.example``

.. literalinclude:: /_static/scripts/envs/openstack_single.env.example
   :language: yaml

**OpenStack cluster full example env**

``/_static/scripts/envs/openstack_single.env.example``

.. literalinclude:: /_static/scripts/envs/openstack_cluster.env.example
   :language: yaml

All of the parameters seen in full env examples have default values that can be overrided. Example env files for various available configurations:
